...
const Resume = () => {
  const resumeUrl = 'https://docs.google.com/document/d/1fARAkZEihFyhaO5RhNy06450LM5zl6ok/edit?usp=share_link&ouid=104673918223840784147&rtpof=true&sd=true'; // replace with your resume link
